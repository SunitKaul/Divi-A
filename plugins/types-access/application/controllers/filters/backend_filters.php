...
class BackendFilters {
	 ...
	 * @param $profileuser
	 */
	public function save_user_options( $profileuser ) {
	...
	*/
	...
	public function admin_add_help() {
        ...
        '
			...
			. '
		<a href="https://toolset.com/documentation/user-guides/setting-access-control/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access" title="'
        ...
        '
			...
			. '
		<a href="https://toolset.com/documentation/user-guides/setting-access-control/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access#taxonomy" title="'
        ...
        '
			...
			. '
		<a href="https://toolset.com/documentation/user-guides/limiting-read-access-specific-content/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access" title="'
        ...
        '
			...
			. '
			<a href="https://toolset.com/documentation/user-guides/access-control-for-user-fields/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access" title="'
        ...
        '
			...
			. '
			<a href="https://toolset.com/documentation/user-guides/access-control-for-cred-forms/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access" title="'
        ...
        '
			...
			. '
		<a href="https://toolset.com/documentation/user-guides/managing-wordpress-admin-capabilities-access/?utm_source=access&utm_medium=admin-tabs&utm_term=Access%20Control%20for%20Taxonomies&utm_campaign=access" title="'
		...
		if ( ! isset( $this->exclude_caps_array[ $args[0] ] ) && $access_capabilities->is_managed_capability( $args[0] ) ) {
			...
			if ( $access_roles->is_administrator( $user ) ) {
				...
				$access_cache_user_has_cap_key = md5(
					'access::user_caps_' . implode( '-', $caps ) . '_' . serialize( $args ) . '#' . $user->ID
				);
	...
	public function toolset_access_select_group_metabox() {
		...
		$post_type_exclude_list = $post_type_exclude_list_object->get();
		if (
			isset( $post )
			&& is_object( $post )
			&& '' != $post->ID
