...
class Toolset_Addon_Maps_Views_Distance_Filter extends Toolset_Maps_Views_Distance {
	...
	private function maybe_apply_missing_filter_settings_from_url( $view_settings ) {
		if ( ! $this->is_distance_filter_requested( $view_settings ) ) {
	 ...
	 * @return bool
	 */
	private function is_distance_filter_requested( array $view_settings ) {
		return array_key_exists( 'map_distance_filter', $view_settings );
	}
